...
class Ex126
{
  ...
  private static class ManyLocks
  {
	  ...
	  public static LockTreeLock lock_five = new LockTreeLock("Lock5");
		...
		public static Semaphore global_Semaphore = new Semaphore(1);
  ...
  private static class Thread1 extends Thread
  {
    ...
    LockTreeLock lock_four_ = ManyLocks.lock_five;
    LockTreeLock lock_five_ = ManyLocks.lock_four;
    ...
    public void run()
    {
    	...
    	try {
    		ManyLocks.global_Semaphore.acquire();
      ...
      ManyLocks.global_Semaphore.release();
    }
