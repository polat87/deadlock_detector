...
/***
 *  Locktree detects a possible dead lock, but there is non
 *  because we use an other type of lock which works as a gate lock
 */
class Ex080
{
  ...
  private static class ManyLocks
  {
    ...
    public static boolean TurnOfThread1 = true;
  }
