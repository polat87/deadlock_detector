...
class Ex083
{
  ...
  private static class ManyLocks
  {
	  ...
	  public static boolean lock_guard = true;
  ...
  private static class Thread1 extends Thread
  {
    ...
    public void run()
    {
        ...
        while(ManyLocks.lock_guard == false)
        {
        	yield();
        }
        lock_four_.lock();
  ...
  private static class Thread2 extends Thread 
  {
    ...
    public void run()
    {
    	 while(ManyLocks.lock_guard == true)
         {
         	yield();
         }
         lock_six_.lock();
