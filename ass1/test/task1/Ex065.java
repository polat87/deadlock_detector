...
class Ex065{
    ...
    private static class ManyLocks {
        ...
        public static LockTreeLock lock_four = new LockTreeLock("GateLock1");
        public static LockTreeLock lock_five = new LockTreeLock("GateLock2");
    }
    ...
    private static class Thread1 extends Thread {
        ...
        LockTreeLock gatelock_one_ = ManyLocks.lock_four;
        LockTreeLock gatelock_two_ = ManyLocks.lock_five;
    ...
    public static void main(String[] args) {
        Thread1 example1 = new Thread1("Example3Thread 1");
        example1.start();
        ...
        Thread2 example2 = new Thread2("Example3Thread 2");
        example2.start();
