...
class Ex056
{
  ...
  private static class ManyLocks
  {
    ...
    public static boolean thread1Running = true;
  ...
  private static class Thread1 extends Thread
  {
    ...
    {
    	lock_four_.lock();
    	while(ManyLocks.thread1Running == false){
    		lock_four_.unlock();
    		yield();
    		lock_four_.lock();
    	}
    	...
    	ManyLocks.thread1Running = false;
    }
  ...
  private static class Thread2 extends Thread {
    ...
    {
    	lock_four_.lock();
    	while(ManyLocks.thread1Running == true){
    		lock_four_.unlock();
    		yield();
    		lock_four_.lock();
    	}
